...
int main(int argc, char *argv[]) {
    ...
    strcpy (lensname_file, lens_primary_link);
    ...
    // Write in the lens files.
    strcpy (fullname_file, lens_primary_link);     // lens_with_link
    ...
    for (i = field_int - 1; i < field_int; i++) {
        ...
        strcpy (lensfile_string, lens_primary_link);   // lens_with_link
        ...
        // Full catalog.
        strcpy (full_string, lens_primary_link);
        ...
        strcpy (goodname_file, gal_link);   // lens_without_link
        strcat (goodname_file, "W");
